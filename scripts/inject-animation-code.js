...
// Auto-prepend GSAP Global Enqueue wenn der Plan GSAP-Snippets enthält
if (snippetSpecs.some(s => s.type === 'gsap')) {
  snippetSpecs.unshift(GSAP_ENQUEUE);
  console.log(' GSAP Global Enqueue Snippet automatisch vorangestellt (priority 10, on_conflict: skip)');
}
